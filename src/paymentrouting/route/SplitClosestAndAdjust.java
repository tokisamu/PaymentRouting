 ...
 *
 */
public class SplitClosestAndAdjust extends PathSelection {

    public SplitClosestAndAdjust(DistanceFunction df) {
        super("SPLIT_CLOSEST", df);
    }

    public SplitClosestAndAdjust(String key, DistanceFunction df) {
        super(key, df);
    }
